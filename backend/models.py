...
class Staff(db.Model):
    ...
    def __init__(self, Staff_ID, Staff_FName, Staff_LName, Email, Password, Access_Rights, Role_ID):
...
class Role(db.Model):
    ...
    def __init__(self, Role_ID, Role_Name, Role_Description, Salary, Dept):
        self.Role_ID = Role_ID
...
class Application(db.Model):
    ...
    def __init__(self, Application_ID, Application_Date, Application_Status, Staff_ID, Listing_ID):
