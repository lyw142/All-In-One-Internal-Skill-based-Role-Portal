...
class TestStaff(unittest.TestCase):
    def test(self):
        s1 = Staff(Staff_FName="John", Staff_LName='Lee', Email="join@gmail.com", Password="1234", Role_ID=1, Country="Singapore", Dept='IT', Access_Rights=1)
...
class TestManager(unittest.TestCase):
    def test(self):
        m1 = Manager(Staff_FName="John", Staff_LName='Lee', Email="join@gmail.com", Password="1234", Role_ID=1, Country="Singapore", Dept='IT', Access_Rights=1,ResponsibleTeam="Dev", Reporting_Manager=1)
...
class TestDirector(unittest.TestCase):
    def test(self):
        d1 = Director(Staff_FName="John", Staff_LName='Lee', Email="join@gmail.com", Password="1234", Role_ID=1, Country="Singapore", Dept='IT', Access_Rights=1, ResponsibelDept="IT", Reporting_Manager=1)
...
class TestNormalStaff(unittest.TestCase):
    def test(self):
        ns1 = NormalStaff(Staff_FName="John", Staff_LName='Lee', Email="John@gmail.com", Password="1234", Role_ID=1, Country="Singapore", Dept='IT', Access_Rights=1, Reporting_Manager=1)
...
class TestRole(unittest.TestCase):
    def test(self): 
        r1 = Role(Role_Name="Developer", Role_Responsibilities="Dev")
        self.assertEqual(
            r1.get_role_details(), 
